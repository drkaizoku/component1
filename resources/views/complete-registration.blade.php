...
<head>
    ...
    <!-- Font-->
    <link rel="stylesheet" type="text/css" href="{{URL::asset('css/stepsopensans-font.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('css/stepsroboto-font.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('stepsfonts/material-design-iconic-font/css/material-design-iconic-font.min.css')}}">
    <!-- datepicker -->
    <link rel="stylesheet" type="text/css" href="{{URL::asset('css/stepsjquery-ui.min.css')}}">
    <!-- Main Style Css -->
    <link rel="stylesheet" href="{{URL::asset('css/stepsstyle.css')}}"/>
</head>
<body>
...
<script src="{{URL::asset('js/stepsjquery-3.3.1.min.js')}}"></script>
<script src="{{URL::asset('js/stepsjquery.steps.js')}}"></script>
<script src="{{URL::asset('js/stepsjquery-ui.min.js')}}"></script>
<script src="{{URL::asset('js/stepsmain.js')}}"></script>
</body>
</html>
